...
Fs = 1e5;
freq_sep = 1e3; % frequency seperator
...
for M_idx = M
    ...
    for SNR = SNR_db
        mod_singal = fskmod(data_symbols, M_idx, freq_sep, nsamp, Fs);
        
        rx_noisy = awgn(mod_singal, SNR, 'measured');
        
        demod_symbols = fskdemod(rx_noisy, M_idx, freq_sep, nsamp, Fs);
