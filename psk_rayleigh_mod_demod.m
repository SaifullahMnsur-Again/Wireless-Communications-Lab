...
for M_idx = M
    ...
    for SNR = SNR_db
        ...
        reset(rayChan); % reset for new snr loop
        
        % block-2 Rayleigh Fading
        [txFaded, pathGains] = step(rayChan, modSignal); % step applies rayleigh channel on modded signal
...
title('BER vs SNR for Different PSK Modulation (Rayleigh)');